...
* (full) python allBacteria_MLmodelComparison-fullData.py
* (test) python allBacteria_MLmodelComparison-fullData.py --samples 500
"""
...
DATA_FILE = os.path.join(modelBuildingDir, 'allBacteriaData_chEMBL_wMACAW_MLready.csv')
OUTPUT_DIR = os.path.join(dataDir, 'Results/bacteriaCommandline')
TEST_SIZE = 0.2
N_CV_FOLDS = 10
RANDOM_STATE = 42
