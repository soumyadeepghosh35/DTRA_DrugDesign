...
* (full) python Step4_BacillusAnthracis_MLmodelComparison.py --n_folds 10 --n_jobs 4 --random_state 42
* (test) python Step4_BacillusAnthracis_MLmodelComparison.py --n_samples 500 --n_folds 5 --n_jobs 4 --random_state 42
"""
...
def load_and_prepare_data(data_dir, n_samples=None, random_state=42):
    ...
    file_path = os.path.join(model_building_dir, 'BacillusAnthracisData_chEMBL_MLready.csv')
    output_dir = os.path.join(data_dir, 'Results', 'BacillusAnthracis_Commandline')
