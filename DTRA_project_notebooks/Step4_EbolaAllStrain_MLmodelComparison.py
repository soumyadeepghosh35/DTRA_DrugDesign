...
* (full) python EbolaAllStrain_MLmodelComparison.py --n_folds 10 --n_jobs 4 --random_state 42
* (test) python EbolaAllStrain_MLmodelComparison.py --n_samples 500 --n_folds 5 --n_jobs 4 --random_state 42
"""
...
def parse_arguments():
    ...
    parser.add_argument('--output_dir', type=str, default=None,
                        help='Output directory (default: data_dir/Results/EbolaAllStrain_Commandline/)')
...
def load_and_prepare_data(data_dir, n_samples=None, random_state=42):
    ...
    file_path = os.path.join(model_building_dir, 'EbolaAllStrainData_chEMBL_uM_MLready.csv')
...
def main():
    ...
    # Load data
    smiles, Y = load_and_prepare_data(args.data_dir, args.n_samples, args.random_state)
