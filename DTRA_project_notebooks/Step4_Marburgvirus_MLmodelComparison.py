...
def parse_arguments():
    ...
    parser.add_argument('--output_dir', type=str, default=None,
                        help='Output directory (default: data_dir/Results/MarburgvirusCommandline/)')
...
def load_and_prepare_data(data_dir, n_samples=None, random_state=42):
    ...
    file_path = os.path.join(model_building_dir, 'MarburgVirusData_chEMBL_wMACAW_MLready.csv')
