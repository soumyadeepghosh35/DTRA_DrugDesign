...
helpers      = {'O', 'NO', 'O=S(O)O', 'CO', 'O=NO', '[Br][Br]', 'S', 'O=[N+]([O-])O', '[C-]#[O+]', 'C=O', '[H][H]', 'O=C=O', 'C=C', 'O=S=O', 'C#N', 'Br', 'N', 'O=S(=O)(O)O', 'N#CO', 'N#N', 'O=O'}
target       = {'CC(O)(C=NO)Nc1nc2c(ncn2[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[nH]1'}
