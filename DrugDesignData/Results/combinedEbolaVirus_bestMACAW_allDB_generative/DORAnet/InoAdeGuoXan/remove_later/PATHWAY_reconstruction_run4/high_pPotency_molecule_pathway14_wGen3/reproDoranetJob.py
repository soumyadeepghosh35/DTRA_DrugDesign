...
helpers      = {'O=O', 'O=C=O', 'O', '[H][H]', 'O=NO', 'N#N', 'O=[N+]([O-])O', 'C=O', '[C-]#[O+]', 'O=S(O)O', 'O=S(=O)(O)O', 'O=S=O', '[Br][Br]', 'N', 'NO', 'N#CO', 'CO', 'S', 'Br', 'C=C', 'C#N'}
target       = {'CC(O)(Nc1nc2c(ncn2[C@@]23OC[C@@H](O2)[C@@H](O)[C@H]3O)c(=O)[nH]1)C(=O)O'}
