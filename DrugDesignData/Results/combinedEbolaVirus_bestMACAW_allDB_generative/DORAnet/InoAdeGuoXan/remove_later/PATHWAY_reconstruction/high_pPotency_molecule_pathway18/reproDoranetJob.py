...
jobName = "high_pPotency_molecule_pathway18"
starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}
helpers = {'Br', 'N', 'O=NO', 'O=C=O', 'S', 'O=S(O)O', 'O=[N+]([O-])O', 'CO', 'C=C', '[H][H]', 'N#CO', 'O', 'C#N', 'NO', '[Br][Br]', 'N#N', 'O=S(=O)(O)O', '[C-]#[O+]', 'C=O', 'O=O', 'O=S=O'}
target = {"NC(=O)c1ccc[n+]([C@@H]2O[C@H](COP(=O)(O)OP(=O)(O)OC[C@H]3O[C@@H](n4cnc5c(N)ncnc54)[C@H](OP(=O)(O)O)[C@@H]3O)[C@@H](O)[C@H]2O)c1"}
