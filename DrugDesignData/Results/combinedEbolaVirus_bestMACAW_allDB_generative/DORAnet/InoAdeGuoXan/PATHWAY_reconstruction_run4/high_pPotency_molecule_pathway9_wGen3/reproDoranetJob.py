...
helpers      = {'O=O', 'N#CO', 'O', 'N', '[C-]#[O+]', 'C=C', 'O=S=O', 'O=C=O', 'C=O', '[H][H]', 'O=S(O)O', 'S', 'Br', '[Br][Br]', 'CO', 'O=NO', 'NO', 'O=[N+]([O-])O', 'C#N', 'O=S(=O)(O)O', 'N#N'}
target       = {'CC(O)[C@H]1O[C@@H](n2cnc3c(=O)[nH]c(NC=O)nc32)[C@H](O)[C@@]1(C)O'}
