...
helpers      = {'NO', '[Br][Br]', '[H][H]', 'O=O', 'CO', 'S', 'C=C', 'O=S=O', 'O=NO', 'O=S(O)O', 'C#N', 'N#CO', '[C-]#[O+]', 'N#N', 'O=C=O', 'Br', 'O=S(=O)(O)O', 'C=O', 'N', 'O=[N+]([O-])O', 'O'}
target       = {'Cc1nc2c(=O)[nH]c(NC=O)nc2n1[C@@H]1O[C@H](C(=O)O)[C@@H](O)[C@H]1O'}
