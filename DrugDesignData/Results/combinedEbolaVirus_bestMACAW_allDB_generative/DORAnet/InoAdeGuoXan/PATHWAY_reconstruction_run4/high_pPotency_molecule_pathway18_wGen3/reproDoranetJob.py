...
helpers      = {'O', 'O=C=O', 'O=NO', 'O=S(=O)(O)O', 'S', 'O=[N+]([O-])O', 'C#N', 'N#CO', '[C-]#[O+]', 'NO', 'O=S=O', 'CO', '[H][H]', 'Br', 'O=O', 'N', 'O=S(O)O', 'C=O', 'C=C', 'N#N', '[Br][Br]'}
target       = {'C[C@@]1(CO)O[C@@H](n2cnc3c(=O)[nH]c(NC=O)nc32)[C@H](O)[C@@]1(C)O'}
