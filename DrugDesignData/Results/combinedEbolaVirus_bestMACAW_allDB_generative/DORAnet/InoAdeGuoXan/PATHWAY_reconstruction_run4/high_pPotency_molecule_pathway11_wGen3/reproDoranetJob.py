...
helpers      = {'S', 'O', '[Br][Br]', 'NO', 'O=S(O)O', 'Br', 'C=C', 'N#N', 'CO', 'N', 'O=[N+]([O-])O', 'C#N', 'O=NO', '[C-]#[O+]', 'C=O', '[H][H]', 'O=S(=O)(O)O', 'O=S=O', 'O=C=O', 'N#CO', 'O=O'}
target       = {'C[C@]1(O)[C@@H](CO)O[C@@H](n2cnc3c(=O)[nH]c(NC=O)nc32)[C@@]1(C)O'}
