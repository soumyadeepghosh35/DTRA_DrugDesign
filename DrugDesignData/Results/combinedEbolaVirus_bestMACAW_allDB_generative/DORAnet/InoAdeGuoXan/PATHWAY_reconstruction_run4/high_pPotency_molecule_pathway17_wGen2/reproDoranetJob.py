...
helpers      = {'[H][H]', 'O=[N+]([O-])O', 'NO', 'N#N', 'C#N', 'O', 'O=S(=O)(O)O', 'Br', 'O=O', 'O=S=O', 'CO', 'C=O', '[C-]#[O+]', 'O=NO', '[Br][Br]', 'O=C=O', 'O=S(O)O', 'S', 'N#CO', 'N', 'C=C'}
target       = {'CC(=O)O[C@H]1[C@H](n2cnc3c(N)ncnc32)O[C@@H]2C(O)O[C@]21O'}
