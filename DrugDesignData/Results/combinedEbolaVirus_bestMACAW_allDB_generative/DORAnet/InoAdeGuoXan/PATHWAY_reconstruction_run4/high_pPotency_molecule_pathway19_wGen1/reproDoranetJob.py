...
helpers      = {'NO', 'O=NO', 'N', 'N#N', 'Br', '[H][H]', 'O=S(=O)(O)O', '[Br][Br]', '[C-]#[O+]', 'O=[N+]([O-])O', 'C=C', 'O=S(O)O', 'C#N', 'C=O', 'O=S=O', 'CO', 'N#CO', 'O=C=O', 'S', 'O', 'O=O'}
target       = {'C[n+]1cn2c3nc([nH]c(=O)c31)N=C(O)[C@H]1O[C@@H]2[C@H](O)[C@@H]1O'}
