...
jobName = "high_pPotency_molecule_pathway1"
starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}
helpers = {'C#N', 'N', 'S', '[H][H]', 'O=S=O', 'N#CO', 'O=S(=O)(O)O', '[Br][Br]', 'O=NO', 'O', 'C=O', 'NO', 'N#N', 'CO', 'O=[N+]([O-])O', 'O=S(O)O', 'Br', 'O=O', 'O=C=O', '[C-]#[O+]', 'C=C'}
target = {"CC(=O)SCCNC(=O)CCNC(=O)[C@H](O)C(C)(C)COP(=O)(O)OP(=O)(O)OC[C@H]1O[C@@H](n2cnc3c(N)ncnc32)[C@H](O)[C@@H]1OP(=O)(O)O"}
