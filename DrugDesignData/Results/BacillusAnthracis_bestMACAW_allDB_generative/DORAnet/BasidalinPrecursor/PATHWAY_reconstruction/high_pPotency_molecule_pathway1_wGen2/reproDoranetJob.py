...
helpers = {'C=O', 'O=O', 'C#N', 'O=C=O', 'N#N', 'O=[N+]([O-])O', 'O=S(=O)(O)O', 'CO', 'O', 'Br', 'C=C', '[H][H]', 'N#CO', 'S', 'N', 'NO', 'O=S=O', '[C-]#[O+]', '[Br][Br]', 'O=S(O)O', 'O=NO'}
target = {"Nc1ncnc2c1ncn2[C@@H]1O[C@H](COP(=O)(O)OP(=O)(O)OP(=O)(O)O)[C@@H](O)[C@H]1O"}
